...
/decl/hierarchy/skill/general/computer
	...
	desc = "Describe su comprension de las computadoras, el software y la comunicacion. No es un requisito para usar computadoras, pero definitivamente ayuda. Se usa en telecomunicaciones y programacion de computadoras e IA."
...
/decl/hierarchy/skill/research/devices
	...
	desc = "Describe la capacidad de ensamblar dispositivos complejos, como computadoras, circuitos, impresoras, robots o ensamblajes de tanques de gasolina (bombas). Tenga en cuenta que si un dispositivo requiere electronica o programacion, esas habilidades tambien se requieren ademas de esta habilidad."
...
/decl/hierarchy/skill/research/science
	...
	levels = list( "Inexperto"			= "Sabes lo que es la ciencia y probablemente tengas una vaga idea del metodo cientifico de tus clases de ciencias de la escuela secundaria.",
						...
						"Entrenado"			= "Eres un cientifico, quizas un estudiante de posgrado o un investigador de posgrado. Puedes planear un experimento, analizar tus resultados, publicar tus datos e integrar lo que has aprendido con la investigacion de otros cientificos. Tus habilidades son confiables y sabes como encontrar la informacion que necesita cuando investigas un nuevo tema cientifico. Puede diseccionar xenofauna exotica sin muchos problemas.<br>- Puede determinar la composicion de una atmosfera al escanear exoplanetas.<br>- Puedes determinar la cantidad de estructuras artificiales al escanear exoplanetas.<br>- Puedes realizar con exito cirugias en limos.",
...
/decl/hierarchy/skill/medical/medical
	...
	levels = list( "Inexperto"			= "Conoce primeros auxilios, como aplicar un vendaje o unguento a una lesion. Puede usar un autoinyector para uso civil, probablemente leyendo las instrucciones impresas en el. Puede saber cuando alguien esta gravemente herido y necesita un medico, puede ver si alguien tiene un hueso gravemente roto, si tiene problemas para respirar o si esta inconsciente. Es posible que tenga problemas para diferenciar entre inconsciente y muerto a distancia.<br>- Puede usar suministros de primeros auxilios que se encuentran en kits y bolsas, incluidos los autoinyectores.",
