...
/datum/job/junior_doctor
	...
	title_english = "Medical Resident"
	department = "Medico"
	department_flag = MED
	minimal_player_age = 2
...
/datum/job/doctor
	...
	title_english = "Medical Technician"
	total_positions = 3
	spawn_positions = 3
	supervisors = "El Jefe Medico Oficial y el personal medico"
	economic_power = 7
...
/datum/job/doctor/get_description_blurb()
	return "Un tecnico medico es el enlace entre un tripulante lesionado y el tratamiento adecuado en la enfermeria de Torch. Su trabajo consiste en vigilar los sensores, evaluar las lesiones, llevar a alguien a la bahia medica y mantener con vida a los pacientes criticos entre la lesion y la cirugia."

/datum/job/medical_trainee
	title = "Aprendiz de Tecnico Medico"
	title_english = "Trainee Medical Technician"
	department = "Medical"
	department_flag = MED
	total_positions = 1
	spawn_positions = 1
...
/datum/job/chemist/get_description_blurb()
	return "Eres el farmaceutico. Usted hace medicina y otras sustancias utiles. No es medico ni cirujano; No debe tratar a los pacientes, sino proporcionar el medicamento. Estas subordinado a los medicos y tecnicos medicos."

/datum/job/psychiatrist
	title = "Consejero"
	title_english = "Counselor"
	total_positions = 1
	spawn_positions = 1
	ideal_character_age = 40
	economic_power = 5
...
/datum/job/psychiatrist/get_description_blurb()
		return "Eres el consejero. Su principal responsabilidad es la salud mental y el bienestar de la tripulacion. Estas subordinado al Jefe medico oficial."
