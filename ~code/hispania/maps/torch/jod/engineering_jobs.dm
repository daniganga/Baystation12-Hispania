...
/datum/job/engineer_trainee
	...
	title_english = "Engineer Trainee"
	department = "Ingenieria"
	department_flag = ENG
	total_positions = 2
	spawn_positions = 2
...
/datum/job/roboticist/get_description_blurb()
	return "Eres el Robotista. Usted es responsable de reparar, actualizar y manejar los sinteticos de la nave (como los robots). Tambien usted es responsable de la produccion de exotrajes (mechas) y bots para varios departamentos. Usted responde al Jefe de ingenieria."
