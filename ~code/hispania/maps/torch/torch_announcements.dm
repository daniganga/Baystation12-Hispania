/datum/map/torch
	...
	radiation_detected_message = "Altos niveles de radiacion detectados en la proximidad de la %STATION_NAME%. Evacue a uno de los tuneles de mantenimiento blindados."
