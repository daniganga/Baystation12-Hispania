...
/datum/map/torch/send_welcome()
	...
	var/welcome_text = "<center><img src = sollogo.png /><br /><font size = 3><b>SEV Torch</b> Lecturas de sensores:</font><br>"
	...
	minor_announcement.Announce(message = "Nueva actualizacion de [GLOB.using_map.company_name] disponible en todas las consolas de comunicacion.")
